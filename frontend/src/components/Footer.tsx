...
import { CloudSun, Database, Code2, Globe, Heart } from 'lucide-react';

export const Footer: React.FC = () => {
  return (
    <footer className="w-full glass-panel border-t border-slate-800/80 mt-12 py-10 text-slate-400 text-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3 md:col-span-2">
            <div className="flex items-center gap-2.5">
              <div className="w-8 h-8 rounded-xl bg-gradient-to-tr from-red-600 to-sky-500 flex items-center justify-center text-white font-black text-sm">
                PE
              </div>
              <span className="text-base font-bold text-white tracking-tight">METEO<span className="text-sky-400">PERÚ</span></span>
            </div>
            ...
            <p className="text-[11px] text-slate-500">
              Desarrollado como proyecto académico por el <strong className="text-slate-300">Grupo 02</strong>.
            </p>
          </div>

          {/* Architecture Stack */}
          <div className="space-y-2">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-200 block">Arquitectura & Stack</span>
          ...
          {/* Data Sources */}
          <div className="space-y-2">
            <span className="text-xs font-bold uppercase tracking-wider text-slate-200 block">Fuentes Meteorológicas</span>
